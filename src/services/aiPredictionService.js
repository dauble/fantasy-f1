 ...
 *                  Uses adaptive extended thinking to reason deeply about race
 *                  strategy, driver form, and circuit characteristics before
 *                  making predictions.
 *
  ...
  "current_team_assessment": [
    {
      ...
      "reason": "1 sentence: form, circuit fit, and whether the ${TRANSFER_PENALTY}-pt transfer cost is justified",
